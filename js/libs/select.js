  ...
  optionAction(selectItem, originalSelect, optionItem) {
    ...
    if (!selectOptions.classList.contains('_slide')) {
        if (originalSelect.multiple) { // Якщо мультивибір
            ...
            // Check if data-checkbox attribute is present
            if (originalSelect.hasAttribute('data-checkbox')) {
                // Update the select title to show the count of selected options
                this.setSelectTitleValue(selectItem, originalSelect, selectSelectedItems.length);
            } else {
                // Update the select title normally
                this.setSelectTitleValue(selectItem, originalSelect);
            }
